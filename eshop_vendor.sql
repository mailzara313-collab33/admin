...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2025 at 06:40 AM
...
CREATE TABLE `categories` (
  ...
  `seo_page_title` varchar(1024) DEFAULT NULL,
  `seo_meta_keywords` varchar(10274) DEFAULT NULL,
  `seo_meta_description` varchar(1024) DEFAULT NULL,
  `seo_og_image` varchar(256) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_items` (
  ...
  `affiliate_token` varchar(255) DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `deliverable_zipcodes_group` varchar(512) DEFAULT NULL,
  `deliverable_city_group_type` int(11) NOT NULL DEFAULT 1 COMMENT '(0:none, 1:all, 2:include, 3:exclude)',
  `deliverable_cities_group` varchar(512) DEFAULT NULL,
...
CREATE TABLE `product_variants` (
  ...
  `active_status` enum('active','archived') NOT NULL DEFAULT 'active',
